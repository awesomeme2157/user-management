...
// import "./LoginHistory.css"; // Assume you create corresponding styling
...
//   // Fetch initial logs without date filter on component mount
//   useEffect(() => {
//     if (token) {
//       fetchLoginHistory();
//     }
...
//     // Trigger CSV download by opening the URL
//     window.open(
//       `http://localhost:4000/api/logs/login-history?${params.toString()}`,
//       "_blank"
//     );
...
//   // Handle applying date range filter
